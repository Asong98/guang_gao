...
export class BaseBooleanValue extends BaseValue{
    type ?: 'boolean' = 'boolean'
    value = false
}

export class BaseNumberValue extends BaseValue{
    type ?:'number'= 'number'
    value = 0
...
export class BaseIntValue extends BaseValue{
    type ?:'int'= 'int'
    value = 0
...
export class BaseStringValue extends BaseValue{
    type ?:'string'= 'string'
    value = ''
...
export class BaseColorValue extends BaseValue{
    type ?:'color'= 'color'
    value = ''
}
